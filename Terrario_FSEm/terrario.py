...
def HumidityControl():
    global humidityPercent, pump
    while True:
        try:
            humidity = hygro.read_u16()
            humidityPercent = round((100*humidity/65536),2)
...
def ReadDesiredTemp():
    ...
    return round((15*voltDesiredTemp+1310720)/65536,2)
...
def TemperatureControl():
    ...
    while True:
        try:
            ...
            #print("\r  Desired temperature: {:0.2f}°C".format(desiredTemp), end="")
            #print("\t\t  Current temperature: {:0.2f}°C".format(currentTemp), end="")
